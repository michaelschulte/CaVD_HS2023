...
4. Add a setup chunk as displayed in the image below - loading the packages you need and the data.
...
2. Render the document and observe that the changes to the setup chunk have no *visible* effect due to `include = FALSE`. 
